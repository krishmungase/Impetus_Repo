    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">HealthSphere</h3>
            <p className="text-gray-400 mb-4">
              Empowering healthcare through technology. Your trusted partner in medical services and health management.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/hospital-map" className="text-gray-400 hover:text-white">
                  Hospital Locator
                </Link>
              </li>
              <li>
                <Link to="/mri-analysis" className="text-gray-400 hover:text-white">
                  MRI Analysis
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">contact@healthsphere.com</span>
              </li>
              <li className="flex items-center">
